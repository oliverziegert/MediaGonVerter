...
type ConfigApiRequestAlgorithmsOpts struct {
	XSdsAuthToken optional.String
}

func (a *ConfigApiService) RequestAlgorithms(ctx context.Context, localVarOptionals *ConfigApiRequestAlgorithmsOpts) (AlgorithmVersionInfoList, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/v4/config/info/policies/algorithms"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v AlgorithmVersionInfoList
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHttpResponse, newErr
...
/*
ConfigApiService Request classification policies
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ConfigApiRequestClassificationPoliciesConfigInfoOpts - Optional Parameters:
     * @param "XSdsAuthToken" (optional.String) -  Authentication token
@return ClassificationPoliciesConfig
*/

type ConfigApiRequestClassificationPoliciesConfigInfoOpts struct {
	XSdsAuthToken optional.String
}

func (a *ConfigApiService) RequestClassificationPoliciesConfigInfo(ctx context.Context, localVarOptionals *ConfigApiRequestClassificationPoliciesConfigInfoOpts) (ClassificationPoliciesConfig, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v4/config/info/policies/classifications"
...
/*
ConfigApiService Request general settings
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ConfigApiRequestGeneralSettingsInfoOpts - Optional Parameters:
     * @param "XSdsAuthToken" (optional.String) -  Authentication token
@return GeneralSettingsInfo
*/

type ConfigApiRequestGeneralSettingsInfoOpts struct {
	XSdsAuthToken optional.String
}

func (a *ConfigApiService) RequestGeneralSettingsInfo(ctx context.Context, localVarOptionals *ConfigApiRequestGeneralSettingsInfoOpts) (GeneralSettingsInfo, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v4/config/info/general"
...
/*
ConfigApiService Request infrastructure properties
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ConfigApiRequestInfrastructurePropertiesInfoOpts - Optional Parameters:
     * @param "XSdsAuthToken" (optional.String) -  Authentication token
@return InfrastructureProperties
*/

type ConfigApiRequestInfrastructurePropertiesInfoOpts struct {
	XSdsAuthToken optional.String
}

func (a *ConfigApiService) RequestInfrastructurePropertiesInfo(ctx context.Context, localVarOptionals *ConfigApiRequestInfrastructurePropertiesInfoOpts) (InfrastructureProperties, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v4/config/info/infrastructure"
...
/*
ConfigApiService Request list of notification channels
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ConfigApiRequestNotificationChannelsInfoOpts - Optional Parameters:
     * @param "XSdsAuthToken" (optional.String) -  Authentication token
@return NotificationChannelList
*/

type ConfigApiRequestNotificationChannelsInfoOpts struct {
	XSdsAuthToken optional.String
}

func (a *ConfigApiService) RequestNotificationChannelsInfo(ctx context.Context, localVarOptionals *ConfigApiRequestNotificationChannelsInfoOpts) (NotificationChannelList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v4/config/info/notifications/channels"
...
/*
ConfigApiService Request password policies
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ConfigApiRequestPasswordPoliciesConfigInfoOpts - Optional Parameters:
     * @param "XSdsAuthToken" (optional.String) -  Authentication token
@return PasswordPoliciesConfig
*/

type ConfigApiRequestPasswordPoliciesConfigInfoOpts struct {
	XSdsAuthToken optional.String
}

func (a *ConfigApiService) RequestPasswordPoliciesConfigInfo(ctx context.Context, localVarOptionals *ConfigApiRequestPasswordPoliciesConfigInfoOpts) (PasswordPoliciesConfig, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v4/config/info/policies/passwords"
...
/*
ConfigApiService Request list of configured S3 tags
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ConfigApiRequestS3TagsInfoOpts - Optional Parameters:
     * @param "XSdsAuthToken" (optional.String) -  Authentication token
@return S3TagList
*/

type ConfigApiRequestS3TagsInfoOpts struct {
	XSdsAuthToken optional.String
}

func (a *ConfigApiService) RequestS3TagsInfo(ctx context.Context, localVarOptionals *ConfigApiRequestS3TagsInfoOpts) (S3TagList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v4/config/info/s3_tags"
...
/*
ConfigApiService Request default values
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ConfigApiRequestSystemDefaultsInfoOpts - Optional Parameters:
     * @param "XSdsAuthToken" (optional.String) -  Authentication token
@return SystemDefaults
*/

type ConfigApiRequestSystemDefaultsInfoOpts struct {
	XSdsAuthToken optional.String
}

func (a *ConfigApiService) RequestSystemDefaultsInfo(ctx context.Context, localVarOptionals *ConfigApiRequestSystemDefaultsInfoOpts) (SystemDefaults, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v4/config/info/defaults"
...
/*
ConfigApiService Request system settings
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ConfigApiRequestSystemSettingsOpts - Optional Parameters:
     * @param "XSdsAuthToken" (optional.String) -  Authentication token
@return ConfigOptionList
*/

type ConfigApiRequestSystemSettingsOpts struct {
	XSdsAuthToken optional.String
}

func (a *ConfigApiService) RequestSystemSettings(ctx context.Context, localVarOptionals *ConfigApiRequestSystemSettingsOpts) (ConfigOptionList, *http.Response, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Get")
		localVarPostBody    interface{}
		localVarFileName    string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v4/config/settings"
...
/*
ConfigApiService Update system settings
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body
 * @param optional nil or *ConfigApiUpdateSystemSettingsOpts - Optional Parameters:
     * @param "XSdsAuthToken" (optional.String) -  Authentication token

*/

type ConfigApiUpdateSystemSettingsOpts struct {
	XSdsAuthToken optional.String
}

func (a *ConfigApiService) UpdateSystemSettings(ctx context.Context, body ConfigOptionList, localVarOptionals *ConfigApiUpdateSystemSettingsOpts) (*http.Response, error) {
	var (
